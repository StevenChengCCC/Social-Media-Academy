  ...
  'en': {
    ...
    sections: {
      privacy: {
        ...
        steps: [
          'User Settings → <b>Privacy & Safety</b> → Turn on <b>Keep me safe</b> (scans DMs).',
          '<b>Who can send you a friend request</b>: Only <b>Friends of friends</b> or turn off Everyone.',
          'Server → Server Settings → <b>Moderation</b>: Enable age/phone verification level, anti-spam.',
      ...
      security: {
        ...
        steps: [
          '<b>Enable 2FA</b>: User Settings → <b>My Account</b> → <b>Enable Two-Factor Auth</b>. This greatly protects your account from unauthorized logins.',
          '<b>Server Role Permissions</b>: In your server, carefully assign roles and limit dangerous permissions (like Kick/Ban, Manage Webhooks, or Administrator) only to trusted Moderators.',
          '<b>Anti-Raid Setup</b>: For public servers, enable higher Verification Levels (e.g., must have a phone verified account) to deter spam and raids.',
        ]
      },
      time: {
        h2: 'Time & Distraction', pill1: 'Do Not Disturb', pill2: 'Mute channels',
        steps: [
          'Set status to <b>Do Not Disturb</b>; Right-click channel/category → <b>Mute</b> for X hours / until I turn it back on.',
      ...
      family: {
        ...
        steps: [
          'User Settings → <b>Family Center</b>: Parent and teen link after mutual consent.',
          'Parent can see: which servers were joined, who was added as a friend, shared time usage; <b>cannot see</b> message content.',
        ]
      }
    },
    ytTitles: {
      family: 'How to Set up Discord Parental Controls (Family Center & DM Scanning)',
  ...
  'zh-CN': {
    ...
    sections: {
      privacy: {
        ...
        steps: [
          '用户设置 → <b>隐私与安全</b> → 打开 <b>保护我安全</b>（扫描私信）。',
          '<b>谁可以向您发送好友请求</b>：仅 <b>朋友的朋友</b> 或关闭 所有人。',
          '服务器 → 服务器设置 → <b>审核</b>：开启年龄/手机验证等级、反垃圾。',
      ...
      security: {
        ...
        steps: [
          '<b>启用 2FA</b>：用户设置 → <b>我的账户</b> → <b>启用双重认证</b>。这能极大保护您的账户免受未经授权的登录。',
          '<b>服务器角色权限</b>：在您的服务器中，谨慎分配角色，并将危险权限（如踢出/封禁、管理 Webhook 或管理员）仅限于信任的版主。',
          '<b>防突袭设置</b>：对于公共服务器，启用更高的验证级别（例如，必须有手机验证账户）以阻止垃圾信息和突袭。',
        ]
      },
      time: {
        h2: '时间与专注', pill1: '请勿打扰', pill2: '频道静音',
        steps: [
          '状态设为 <b>请勿打扰</b>；右击频道/分类 → <b>静音</b> X 小时 / 直到我重新开启。',
      ...
      family: {
        ...
        steps: [
          '用户设置 → <b>家庭中心</b>：家长与青少年互相同意后绑定。',
          '家长可看到：加了哪些服务器、加了谁为好友、共用时间段；<b>看不到</b>消息内容。',
        ]
      }
    },
    ytTitles: {
...
export default function Discord({ lang }){
  ...
  return (
    <div className="page">
      ...
      <div className="doc discord"> {/* Added class for specific gradient */}
        <h1>{t.title}</h1>
        ...
        <YouTubeVideo videoId="gsrH3RdqUjk" title={t.ytTitles.family} lang={lang} /> {/* WORKING ID */}
        <YouTubeVideo
            videoId="w6q8HnC6QoQ" title={t.ytTitle}  lang={lang}/>
      </div>
    </div>
  )
}